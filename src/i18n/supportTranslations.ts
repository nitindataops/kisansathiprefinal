...
const hr: SupportTranslations = {
  ...
  securityNotice: 'सारे सौदे अर डेटा किसानसेतु एस्क्रो सुरक्षित सैं।',
  ...
  resolutionThankYou: 'थारे सुझाव खातर धन्यवाद! किसानसेतु हमेशा थारे साथ सै।',
  escalationNotice: (ticketId: string) =>
  ...
  helplineTitle: 'किसानसेतु सरकारी हेल्पलाइन',
  ...
  emailTitle: 'किसानसेतु ईमेल सपोर्ट',
